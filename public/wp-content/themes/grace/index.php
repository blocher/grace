...
<head>
	...
	<script src="<?php echo get_template_directory_uri(); ?>/js/jquery.nicescroll.min.js" type="text/javascript"></script>
	...
	<script src="<?php echo get_template_directory_uri(); ?>/js/animate.js" type="text/javascript"></script>
...
<!-- PRELOADER -->
<img id="preloader" src="<?php echo get_template_directory_uri(); ?>/images/preloader.gif" alt="" />
<!-- //PRELOADER -->
<div class="preloader_hide">
	...
	<div id="page">
		...
		<section id="home" class="padbot0">
			...
			<div id="carousel">
				<ul class="slides">
					<li><img src="<?php echo get_template_directory_uri(); ?>/images/slider/slide1_bg.jpg" alt="" /></li>
					<li><img src="<?php echo get_template_directory_uri(); ?>/images/slider/slide2_bg.jpg" alt="" /></li>
					<li><img src="<?php echo get_template_directory_uri(); ?>/images/slider/slide3_bg.jpg" alt="" /></li>
				</ul>
			</div><!-- //TOP SLIDER -->
		</section><!-- //HOME -->
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-lg-5 col-md-5 col-sm-5 ipad_img_in" data-appear-top-offset="-200" data-animated="fadeInRight">
							<img class="ipad_img1" src="<?php echo get_template_directory_uri(); ?>/images/img1.png" alt="" />
						</div>
					</div><!-- //ROW -->
				</div><!-- //CONTAINER -->
			</div><!-- //MULTI PURPOSE -->
			...
			<div class="projects-wrapper" data-appear-top-offset="-200" data-animated="fadeInUp">
				...
				<div class="owl-demo owl-carousel projects_slider">
					...
					<div class="item">
						<div class="work_item">
							<div class="work_img">
								<img src="<?php echo get_template_directory_uri(); ?>/images/works/1.jpg" alt="" />
								<a class="zoom" href="<?php echo get_template_directory_uri(); ?>/images/works/1.jpg" rel="prettyPhoto[portfolio1]" ></a>
							</div>
					...
					<div class="item">
						<div class="work_item">
							<div class="work_img">
								<img src="<?php echo get_template_directory_uri(); ?>/images/works/2.jpg" alt="" />
								<a class="zoom" href="<?php echo get_template_directory_uri(); ?>/images/works/2.jpg" rel="prettyPhoto[portfolio1]" ></a>
							</div>
							<div class="work_description">
								<div class="work_descr_cont">
									<a href="portfolio-post.html" >Ginger Beast</a>
					...
					<div class="item">
						<div class="work_item">
							<div class="work_img">
								<img src="<?php echo get_template_directory_uri(); ?>/images/works/3.jpg" alt="" />
								<a class="zoom" href="<?php echo get_template_directory_uri(); ?>/images/works/3.jpg" rel="prettyPhoto[portfolio1]" ></a>
							</div>
							<div class="work_description">
								<div class="work_descr_cont">
									<a href="portfolio-post.html" >Ginger Beast</a>
					...
					<div class="item">
						<div class="work_item">
							<div class="work_img">
								<img src="<?php echo get_template_directory_uri(); ?>/images/works/4.jpg" alt="" />
								<a class="zoom" href="<?php echo get_template_directory_uri(); ?>/images/works/4.jpg" rel="prettyPhoto[portfolio1]" ></a>
							</div>
							<div class="work_description">
								<div class="work_descr_cont">
									<a href="portfolio-post.html" >Ginger Beast</a>
					...
					<div class="item">
						<div class="work_item">
							<div class="work_img">
								<img src="<?php echo get_template_directory_uri(); ?>/images/works/5.jpg" alt="" />
								<a class="zoom" href="<?php echo get_template_directory_uri(); ?>/images/works/5.jpg" rel="prettyPhoto[portfolio1]" ></a>
							</div>
							<div class="work_description">
								<div class="work_descr_cont">
									<a href="portfolio-post.html" >Ginger Beast</a>
					...
					<div class="item">
						<div class="work_item">
							<div class="work_img">
								<img src="<?php echo get_template_directory_uri(); ?>/images/works/6.jpg" alt="" />
								<a class="zoom" href="<?php echo get_template_directory_uri(); ?>/images/works/6.jpg" rel="prettyPhoto[portfolio1]" ></a>
							</div>
							<div class="work_description">
								<div class="work_descr_cont">
									<a href="portfolio-post.html" >Ginger Beast</a>
					...
					<div class="item">
						<div class="work_item">
							<div class="work_img">
								<img src="<?php echo get_template_directory_uri(); ?>/images/works/7.jpg" alt="" />
								<a class="zoom" href="<?php echo get_template_directory_uri(); ?>/images/works/7.jpg" rel="prettyPhoto[portfolio1]" ></a>
							</div>
							<div class="work_description">
								<div class="work_descr_cont">
									<a href="portfolio-post.html" >Ginger Beast</a>
				...
				<div class="container" data-appear-top-offset="-200" data-animated="fadeInUp">
					...
					<div class="row">
						<div class="col-lg-2 col-md-2 col-sm-2 client_img">
							<img src="<?php echo get_template_directory_uri(); ?>/images/clients/1.jpg" alt="" />
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 client_img">
							<img src="<?php echo get_template_directory_uri(); ?>/images/clients/2.jpg" alt="" />
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 client_img">
							<img src="<?php echo get_template_directory_uri(); ?>/images/clients/3.jpg" alt="" />
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 client_img">
							<img src="<?php echo get_template_directory_uri(); ?>/images/clients/4.jpg" alt="" />
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 client_img">
							<img src="<?php echo get_template_directory_uri(); ?>/images/clients/5.jpg" alt="" />
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 client_img">
							<img src="<?php echo get_template_directory_uri(); ?>/images/clients/6.jpg" alt="" />
						</div>
					</div><!-- //ROW -->
				</div><!-- CONTAINER -->
			</div><!-- //OUR CLIENTS -->
				...
				<div class="row" data-appear-top-offset="-200" data-animated="fadeInUp">
					...
					<div class="owl-demo owl-carousel team_slider">
						...
						<div class="item">
							<div class="crewman_item">
								<div class="crewman">
									<img src="<?php echo get_template_directory_uri(); ?>/images/team/5.jpg" alt="" />
								</div>
								<div class="crewman_descr center">
									<div class="crewman_descr_cont">
										<p>Jim Moss</p>
						...
						<div class="item">
							<div class="crewman_item">
								<div class="crewman">
									<img src="<?php echo get_template_directory_uri(); ?>/images/team/6.jpg" alt="" />
								</div>
								<div class="crewman_descr center">
									<div class="crewman_descr_cont">
										<p>John Marks</p>
						...
						<div class="item">
							<div class="crewman_item">
								<div class="crewman">
									<img src="<?php echo get_template_directory_uri(); ?>/images/team/7.jpg" alt="" />
								</div>
								<div class="crewman_descr center">
									<div class="crewman_descr_cont">
										<p>Joe Mades</p>
						...
						<div class="item">
							<div class="crewman_item">
								<div class="crewman">
									<img src="<?php echo get_template_directory_uri(); ?>/images/team/8.jpg" alt="" />
								</div>
								<div class="crewman_descr center">
									<div class="crewman_descr_cont">
										<p>Julia Anderson</p>
