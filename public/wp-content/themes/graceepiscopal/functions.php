...
if ($timber_loaded && $acf_loaded) {
    ...
    class BaseSite extends TimberSite
    {
        ...
        function enqueue_styles()
        {
            ...
            wp_enqueue_style('fontawesome', '//maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css', [], null);

            wp_enqueue_style('mainstyle', get_template_directory_uri() . '/css/style.css?v=1.12', [], null);
        ...
        function enqueue_scripts()
        {
           ...
           // wp_enqueue_script('carousel-js', get_template_directory_uri() . '/js/owl.carousel.js', [], null, true);
            ...
            wp_enqueue_script('myscript-js', get_template_directory_uri() . '/js/myscript.js?v=1.7', [], null, true);
